# noaa_weber_wuertz_temp Ingestion Pipeline

The noaa_weber_wuertz_temp ingestion pipeline was created from a cookiecutter template. This README file contains
