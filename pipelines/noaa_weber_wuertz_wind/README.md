# noaa_weber_wuertz_wind Ingestion Pipeline

The noaa_weber_wuertz_wind ingestion pipeline was created from a cookiecutter template. This README file contains
