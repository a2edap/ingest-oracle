# CSI-Datalogger-Surface-Met Ingestion Pipeline

The CSI-Datalogger-Surface-Met ingestion pipeline was created from a cookiecutter template. This README file contains
